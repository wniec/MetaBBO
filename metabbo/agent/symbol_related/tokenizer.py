...
class MyTokenizer(Tokenizer):
    def __init__(self):
        super().__init__()
        self.variables = ["x", "gb", "gw", "dx", "randx", "pb"]
        self.binary_ops = ["+", "*"]
        self.unary_ops = [
            # "sin",
            # "cos",
        ...
        self.leaf_index = np.arange(len(self.vocab))[
            len(self.vocab) - len(self.leafs) :
        ]
        ...
        self.non_const_index = list(
            set(range(self.vocab_size)) - set(self.constants_index)
        )
